# ARCHIVED ADR 001: Technology Stack Selection (Old Next.js Application)

**ARCHIVED:** This ADR described the old Next.js application that was removed on 2026-01-19. The pipeline system (Fastify + Vite) is now the only active system. See ADR-001-fastify-backend.md for current backend architecture.
...
**Supersedes:** N/A
**Superseded by:** ADR-001-fastify-backend.md, ADR-003-vite-react-frontend.md
