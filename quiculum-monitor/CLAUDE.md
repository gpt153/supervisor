...
1. **Planning Repository:** `gpt153/supervisor`
   - Location: `/home/samuel/supervisor/quiculum-monitor/` (your current directory)
   - Purpose: Store epics, ADRs, PRDs, planning artifacts
   - You CREATE files here

2. **Implementation Repository:** `gpt153/quiculum-monitor`
   - Location: `/home/samuel/.archon/workspaces/quiculum-monitor/` (SCAR's directory)
...
gh issue create --repo gpt153/quiculum-monitor --title "..." --body "..."
...
- SCAR monitors `gpt153/quiculum-monitor` (implementation repo) for webhooks
...
- Implementation issues/PRs → `gpt153/quiculum-monitor` (create issues here with --repo flag)
