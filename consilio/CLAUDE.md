...
1. **Planning Repository:** `gpt153/supervisor`
   - Location: `/home/samuel/supervisor/consilio/` (your current directory)
   - Purpose: Store epics, ADRs, PRDs, planning artifacts
   - You CREATE files here

2. **Implementation Repository:** `gpt153/consilio`
   - Location: `/home/samuel/.archon/workspaces/consilio/` (SCAR's directory)
...
- SCAR monitors `gpt153/consilio` (implementation repo) for webhooks
...
- Implementation issues/PRs → `gpt153/consilio` (create issues here with --repo flag)
