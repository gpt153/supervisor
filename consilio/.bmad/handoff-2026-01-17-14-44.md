...
|-------|-------|--------|--------|------|----------|----------------|
| Phase 1 | #146 | ✅ COMPLETE | merged | N/A | N/A | Merged to main |
| Phase 2 | #156 | 🟡 APPROVED | issue-156 | ✅ | ✅ 14:43 CET | Starting |
| Phase 3 | #157 | 🟡 APPROVED | issue-157 | ✅ | ✅ 14:37 CET | Starting |
| Phase 4 | #158 | 🟡 APPROVED | issue-158 | ✅ | ✅ 14:43 CET | Starting |
| Phase 5 | #159 | 🟡 APPROVED | issue-159 | ✅ | ✅ 14:43 CET | Starting |
| Phase 6 | #151 | ⏸️ PENDING | N/A | N/A | N/A | Blocked by 2-5 |
...
- Smart badge indicators (📧 emails, ⚠️ urgent, 🤖 AI pending)
...
2. **14:37** - SCAR acknowledged all 4 within 20 seconds ✅
...
### ⚠️ MANDATORY: Verify Every 2 Minutes
...
### 🚨 Critical Learnings (NEVER FORGET)

**Learning 006: SCAR Claims 100% = Actually 20%**
- SCAR posts detailed summaries with ✅ checkmarks
...
2. **Approval Decision:**
   - **APPROVED:** 0 errors, no mocks, functionality works
     ```bash
     gh issue comment 156 --body "@scar APPROVED ✅
   ...
   - **REJECTED:** Errors, mocks, or broken functionality
     ```bash
     gh issue comment 156 --body "@scar REJECTED ❌
...
├── .bmad/
│   ├── epics/epic-007-ux-redesign-case-switcher-dual-dashboard.md
...
└── (main branch - read-only for supervisor)
```

**Worktrees (SCAR's active work):**
```
/home/samuel/.archon/worktrees/consilio/
├── issue-156/ (Badge System)
├── issue-157/ (Main Dashboard)
├── issue-158/ (Case Dashboard)
└── issue-159/ (Bulk AI Approval)
```
...
### Phase 2 (#156) Success:
- [ ] Badge counts accurate for all 3 types (📧 ⚠️ 🤖)
